...
LOGO_IMAGEM = "logo2.jpeg"      # se não existir, procuramos outra imagem na pasta
...
historico = [
    {"role": "system",
     "content": "Você é Maives, assistente pessoal de negócios da RainbowSublime. Responda em português do Brasil, em uma única frase, com tom profissional, direto e objetivo."}
]
ocupado = False
