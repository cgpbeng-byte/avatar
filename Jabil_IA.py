...
# ---- LOGO (box + imagem) ----
LOGO_IMAGEM = "logo.png"      # nome preferencial; se não existir, tentamos achar outra imagem na pasta
...
def anim_worker():
    ...
    # --- Função para desenhar o logo box ---
...
def responder(texto: str):
    ...
    try:
        ...
        # Engine de TTS criado por chamada/thread
